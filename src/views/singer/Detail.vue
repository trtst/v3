...
const getArtistDesc = async () => {
    const { data: res } = await proxy.$http.artistDesc({ id: info.id, timestamp: new Date().valueOf() })
...
const getArtistAlbum = async() => {
    ...
    info['artist'] = res.artist;
    info['albumSize'] = res.artist.albumSize;
        ...
        <div class="detail-container">
            <div class="detail-main">
                <div class="detail-headImg">
                    <el-image :src="info.artist.picUrl">
                ...
                <div class="detail-info">
                    <div class="cover">
                        <div class="cover-img">
                            <el-image :src="info.artist.img1v1Url">
                                <div slot="placeholder" class="image-slot">
                                    <i class="iconfont icon-placeholder"></i>
                                </div>
                            </el-image>
                ...
                <div class="singer-main">
                    ...
                    <div class="singer-list" v-else>
                        <song-list :songList="info.hotSongs" :stripe="true" v-show="info.type === 'hot'"></song-list>
                        <album-list :albumList="info.hotAlbums" v-show="info.type === 'album'" :loading="info.isLoading"></album-list>
                    </div>
                    <div class="pagination" v-if="info.type !== 'hot'">
                        <el-pagination
                            v-model:currentPage="currentPage"
                            :page-size="info.limit"
                            layout="prev, pager, next"
                            :total="info.albumSize"
